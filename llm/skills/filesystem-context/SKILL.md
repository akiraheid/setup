...
Agents can write learned preferences to instruction files (e.g. MEMORIES.md) for incorporation in subsequent sessions. Use sparingly; validate before persisting.
